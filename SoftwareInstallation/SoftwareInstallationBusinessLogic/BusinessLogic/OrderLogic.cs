...
namespace SoftwareInstallationBusinessLogic.BusinessLogic
{
    public class OrderLogic
    {
        ...
        public OrderLogic(IOrderStorage orderStorage, IPackageStorage packageStorage, IClientStorage clientStorage, IWarehouseStorage warehouseStorage)
        {
        ...
        public void CreateOrder(CreateOrderBindingModel model)
        {
            ...
            {
                MaidAddress = _clientStorage.GetElement(new ClientBindingModel
                {
                    Id = model.ClientId
                })?.Email,
                Subject = $"Новый заказ",
